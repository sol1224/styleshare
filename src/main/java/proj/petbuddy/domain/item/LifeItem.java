...
public class LifeItem {
    ...
    @Builder
    public LifeItem(Category category, String brand, String name, String vendorName, Integer price, Integer vendorPrice, Integer discount, String color, String size, String detailPage, SellStatus sellStatus, Display display, String imgStr) {
//        this.category = category;
    ...
    public LifeItem toDTO(LifeItem dto) {
        dto.setSeq(this.seq);
