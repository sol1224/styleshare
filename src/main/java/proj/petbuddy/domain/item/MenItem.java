...
public class MenItem {
    ...
    @Builder
    public MenItem(Category category, String brand, String name, String vendorName, Integer price, Integer vendorPrice, Integer discount, String color, String size, String detailPage, SellStatus sellStatus, Display display, String imgStr) {
    ...
    public MenItem toDTO(MenItem dto) {
        dto.setSeq(this.seq);
